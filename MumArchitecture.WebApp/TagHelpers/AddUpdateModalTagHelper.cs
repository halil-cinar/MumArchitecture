...
{
    [HtmlTargetElement("addupdatemodal")]
    public class AddUpdateModalTagHelper:TagHelper
    {
        ...
        public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
        {
            ...
            sb.AppendLine($"<form id=\"{Id}_form\" class=\"row g-3\" data-get-url=\"{GetUrl}\" data-save-url=\"{Url}\">");
